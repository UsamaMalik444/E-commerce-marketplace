    ...
    return (
      <>
        ...
        <section className="page_404">
          <Container>
            <Row>
              <div className="col-md-6 align-self-center justify-self-center">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"
              ...
              <div className="col-md-6 align-self-center">
                <h1>404</h1>
                <h2>Oops! We've hit a digital detour</h2>
                <p>
                  Feel free to contact our friendly support team if you need any
                  assistance or have questions about your expedition. We're
                  always here to help you navigate the Web3 world.
                </p>
                <a className="btn_back_404" href="/">
                  {/* <IoChevronBack /> */}
                  <span>Now, let's teleport you back to the action!</span>
                </a>
              </div>
            </Row>
          </Container>
