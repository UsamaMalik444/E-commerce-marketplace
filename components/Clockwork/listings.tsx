...
const ClockworkSettingsList = () => {
  ...
  useEffect(() => {
    async function fetchClockworkSettings() {
      ...
      // })
      const response = await getAllClockworkSettingsInDatabase();
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  {setting.price} {setting.token} for {setting.totalDays} days
                </p>
              </div>
...
export default ClockworkSettingsList;
